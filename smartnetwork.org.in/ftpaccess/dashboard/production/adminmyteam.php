                                                ...
                                                <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            $data = mysqli_fetch_assoc($res);
                                                            $my_ref = $data['my_ref_code'];
                                                            $sql1 = "SELECT * FROM joinus WHERE ref_code = '$my_ref' AND status = 'Activate'";
                                                            $res1 = $conn->query($sql1);
                                                            while($row = mysqli_fetch_assoc($res1)){
                                                                $total_directJoin=mysqli_query($conn,"SELECT * FROM joinus WHERE ref_code = '".$row['my_ref_code']."'");
                                                                $total_directJoin_number= mysqli_num_rows($total_directJoin);
                                                        ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo $row['my_ref_code']; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $total_directJoin_number; ?>
                                                            </td>
                                                        </tr>
                                                        <?php } ?>
                                                    </tbody>

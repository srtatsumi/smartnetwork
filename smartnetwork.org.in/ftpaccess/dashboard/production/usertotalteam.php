                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel"> <!--style="background-color: #abedff;"-->
                                <div class="x_content">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card-box table-responsive">
                                                <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                                                    <thead>
                                                        <tr style="background-color: #52c2ff;">
                                                            <th>Name</th>
                                                            <th>Ref. code</th>
                                                            <th style="background-color: #ffb805;">1st</th>
                                                            <th style="background-color: #ffca45;">2nd</th>
                                                            <th style="background-color: #fad987;">3rd</th>
                                                            <th style="background-color: #d2f700;">4th</th>
                                                            <th style="background-color: #e5ff52;">5th</th>
                                                            <th style="background-color: #edff87;">6th</th>
                                                            <th style="background-color: #1c77ff;">7th</th>
                                                            <th style="background-color: #599cff;">8th</th>
                                                            <th style="background-color: #96c0ff;">9th</th>
                                                            <th style="background-color: #ff14ad;">10th</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php
                                                            $sql = "SELECT * FROM joinus WHERE status = 'Activate' AND my_ref_code = '".$my_ref2."'";
                                                            $res = $conn->query($sql);
                                                        ...
                                                        <tr style="background-color: #52c2ff;">
                                                            ...
                                                            <td style="background-color: #ffb805"><?php echo $first;?></td>
                                                            <td style="background-color: #ffca45"><?php echo $second;?></td>
                                                            <td style="background-color: #fad987"><?php echo $third;?></td>
                                                            <td style="background-color: #d2f700"><?php echo $fourth;?></td>
                                                            <td style="background-color: #e5ff52"><?php echo $fifth;?></td>
                                                            <td style="background-color: #edff87"><?php echo $sixth;?></td>
                                                            <td style="background-color: #1c77ff"><?php echo $seventh;?></td>
                                                            <td style="background-color: #599cff"><?php echo $eight;?></td>
                                                            <td style="background-color: #96c0ff"><?php echo $nine;?></td>
                                                            <td style="background-color: #ff14ad"><?php echo $ten;?></td>
                                                        </tr>
                                                        <?php } ?>
                                                        ...
                                                        <!--Second TIME-->
                                                        <?php
                                                        if (empty($first_level_ref_code)) {
                                                            echo "";
                                                        }
                                                        else{
                                                            foreach ($first_level_ref_code as $first_level_ref_code_value) {
                                                                $sql = "SELECT * FROM joinus WHERE status = 'Activate' AND my_ref_code = '".$first_level_ref_code_value."'";
                                                                $res = $conn->query($sql);
                                                                while($row = mysqli_fetch_assoc($res)){
                                                                    // Calculate the first level
                                                                        $first_level_ref_code = array();
